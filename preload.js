...
contextBridge.exposeInMainWorld('api', {
  ...
  stop: (target) => ipcRenderer.send('chat:stop', target),
  ...
  onRunReport: (cb) => ipcRenderer.on('run:report', (_e, d, route) => cb(d, route)),
  onRunDecisions: (cb) => ipcRenderer.on('run:decisions', (_e, d, route) => cb(d, route)),
  ...
  onTurnCost: (cb) => ipcRenderer.on('stream:cost', (_e, d, route) => cb(d, route)),
  ...
  onToken: (cb) => ipcRenderer.on('stream:token', (_e, t, route) => cb(t, route)),
  onThinking: (cb) => ipcRenderer.on('stream:thinking', (_e, t, route) => cb(t, route)),
  onCleanContent: (cb) => ipcRenderer.on('stream:cleancontent', (_e, t, route) => cb(t, route)),
  onInfo: (cb) => ipcRenderer.on('stream:info', (_e, t, route) => cb(t, route)),
  onState: (cb) => ipcRenderer.on('stream:state', (_e, t, route) => cb(t, route)),
  onSubagent: (cb) => ipcRenderer.on('stream:subagent', (_e, d, route) => cb(d, route)),
  onToolCall: (cb) => ipcRenderer.on('stream:toolcall', (_e, d, route) => cb(d, route)),
  onToolResult: (cb) => ipcRenderer.on('stream:toolresult', (_e, d, route) => cb(d, route)),
  onStats: (cb) => ipcRenderer.on('stream:stats', (_e, d, route) => cb(d, route)),
  onDone: (cb) => ipcRenderer.on('stream:done', (_e, d, route) => cb(d, route)),
